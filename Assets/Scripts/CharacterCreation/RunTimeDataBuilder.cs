...
{"woman_zmb_skeleton", "Biter"},{"man_srv_skinybiter_skeleton", "Biter"}
    ...
    private void InitializeDictionaries()
    {
        filters = new Dictionary<string, List<string>>()
        {
            ...
            {"torso_extra", new List<string> {"torso", "addon", "flashlight", "sixshooter", "element", "sleeves", "belts", "blisters", "scarf", "wpntmp", "bumbag", "centre", "detail", "vest", "wmn_torso_e", "wmn_torso_i", "stethoscope", "center", "top", "fronttop", "front", "dress", "machete_tpp", "coat", "plates", "vest", "jacket", "bubbles", "horns", "guts", "gastank"}},
            {"torso_access", new List<string> {"belt", "bumbag", "flashlight", "wpntmp", "element", "blisters", "scarf", "bumbag", "centre", "fitz_pin_a", "detail", "vest", "wmn_torso_e", "wmn_torso_i", "stethoscope", "center", "top", "fronttop", "front", "torso_b_cape_spikes", "spikes", "knife", "add_", "wrap", "npc_colonel_feathers_a", "axe", "npc_wmn_pants_b_torso_g_tank_top_bumbag_a", "zipper", "rag", "pouch", "collar", "neck", "pocket", "waist_shirt", "chain_armour", "skull_", "plates", "sport_bag", "gastank", "walkietalkie", "man_bdt_belt_c_addon_a", "chain", "battery", "torso_a_pk_top", "man_bdt_torso_d_shirt_c", "wrench", "suspenders", "part", "turtleneck", "npc_waltz_torso_a_glasses_addon", "apron"}},
            ...
            {"armor_torso_upperright", new List<string> {"upperright", "upper_armor_a_right"}},
        ...
        exclude_filters = new Dictionary<string, List<string>>()
        {
            ...
            {"sleeve", new List<string> {"decal", "logo", "headwear", "element", "gloves", "pants", "shoes", "leg", "addon", "torso_armor"}},
